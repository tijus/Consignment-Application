...
namespace App9
{
    ...
    class WebViewStrip : LinearLayout
    {
        ...
        private int[] INDICATOR_COLORS = { 0xEE1B1B, 0xEE1B1B };
        ...
        private WebViewScrollView.TabColorizer mCustomTabColorizer;
        private SimpleTabColorizer mDefaultTabColorizer;

        //Constructors
        public WebViewStrip(Context context) : this(context, null)
        { }

        public WebViewStrip(Context context, IAttributeSet attrs) : base(context, attrs)
        {
        ...
        public WebViewScrollView.TabColorizer CustomTabColorizer
        {
            set
            {
        ...
        protected override void OnDraw(Canvas canvas)
        {
            ...
            WebViewScrollView.TabColorizer tabColorizer = mCustomTabColorizer != null ? mCustomTabColorizer : mDefaultTabColorizer;
        ...
        private class SimpleTabColorizer : WebViewScrollView.TabColorizer
        {
