...
namespace App9
{
    ...
    class WebViewScrollView : HorizontalScrollView
    {
        ...
        private static WebViewStrip mTabStrip;
        ...
        public WebViewScrollView(Context context) : this(context, null) { }

        public WebViewScrollView(Context context, IAttributeSet attrs) : this(context, attrs, 0) { }

        public WebViewScrollView(Context context, IAttributeSet attrs, int defaultStyle)
            : base(context, attrs, defaultStyle)
        {
            ...
            mTabStrip = new WebViewStrip(context);
        ...
        private void PopulateTabStrip()
        {
            ...
            for (int i = 0; i < adapter.Count; i++)
            {
                ...
                tabView.Text = ((WebViewFragment.SamplePagerAdapter)adapter).GetHeaderTitle(i);
